...
if __name__ == "__main__":
    ...
    train_loader, val_loader = create_data_loaders(train_files, train_labels, val_files, val_labels)
    ...
    num_epochs = 30
    model = train_model(model, criterion, optimizer, train_loader, val_loader, device, num_epochs)
    print("TRAINING DONE")
